...
from util import inverse_class
...
def test(lr=1e-3,wd=0,p=0,data='', src_path="test_torch"):
    ...
    #load test data
    with open(src_path + "/test.pickle.pkl","rb") as fr:
        test = pickle.load(fr)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--src_path', type=str, default='test_torch', help='src path for torch data')
    
    args = parser.parse_args()

    test(lr=0.0001,data='cat',src_path=args.src_path)
